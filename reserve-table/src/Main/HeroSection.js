...
function HeroSection() {
  return (
    ...
    <Row className="align-items-center">
      <Col xs={12} md={6} className="mb-4 mb-md-0 text-start flex-start"> {/* Apply the 'text-start flex-start' class here */}
      ...
      {/* The image divs already have the correct classes */}
      <div className="d-none d-lg-block position-absolute pt-5" style={{ transform: 'translate( -50%, 7.5% )',marginLeft:"60%"}}>
