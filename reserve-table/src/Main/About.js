            ...
            <Row className="align-items-center justify-content-around">
                <Col md={6} className="text-column">
                    <div className="text-content">
                        <h1 className="about-title" style={{fontFamily:'Markazi Text',fontSize:'40px',fontWeight:'bold'}}>Little Lemon</h1>
                        <h2 className="mb-4 about-subtitle" style={{fontFamily:'Markazi Text'}}>Chicago</h2>
                ...
                <Col md={5} className="image-column">
                    <Carousel data-bs-theme="dark" activeIndex={index} onSelect={handleSelect} className="h-100">
                        <Carousel.Item className="h-100">
                            <div className="carousel-image-container">
                                <img src={slide1} alt="First slide" className="d-block w-100 h-100 object-fit-cover" />
                            </div>
                            <Carousel.Caption>
                                <h5>Mario and Adrian</h5>
                            </Carousel.Caption>
                        </Carousel.Item>
                        <Carousel.Item className="h-100">
                            <div className="carousel-image-container">
